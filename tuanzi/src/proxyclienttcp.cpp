...
{
    const struct Socks4ConnResp *reply =
            reinterpret_cast<const struct Socks4ConnResp *>(pkg.content);
    unsigned recv_data_times_l = 0, send_data_times_l = 0;
...
{
    const struct Socks5ConnRespHeader *reply =
            reinterpret_cast<const struct Socks5ConnRespHeader *>(pkg.content);
    unsigned recv_data_times_l = 0, send_data_times_l = 0;
